...
# Form implementation generated from reading ui file 'D:\pycharmworkspace\Remote-Banking-Brokers\result.ui'
#
...
class Ui_ResultWindow(object):
    def setupUi(self, ResultWindow):
        ...
        ResultWindow.resize(435, 315)
        ResultWindow.setStyleSheet("QMainWindow {\n"
...
"")
        ...
        item.setBackground(QtGui.QColor(45, 177, 238))
    ...
    def retranslateUi(self, ResultWindow):
        ...
        self.label.setText(_translate("ResultWindow", "Рекомендуемые Вам банки(г.Нижний Новгород)"))
        item = self.tableWidget.horizontalHeaderItem(0)
        item.setText(_translate("ResultWindow", "Рейтинг"))
        item = self.tableWidget.horizontalHeaderItem(1)
        item.setText(_translate("ResultWindow", "Банк"))
        item = self.tableWidget.horizontalHeaderItem(2)
        item.setText(_translate("ResultWindow", "Сайт"))
        item = self.tableWidget.horizontalHeaderItem(3)
        item.setText(_translate("ResultWindow", "Телефон"))
        item = self.tableWidget.horizontalHeaderItem(4)
        item.setText(_translate("ResultWindow", "Отделения"))
        item = self.tableWidget.horizontalHeaderItem(5)
        item.setText(_translate("ResultWindow", "Банкоматы"))
        self.importButton.setText(_translate("ResultWindow", "Импортировать список"))
